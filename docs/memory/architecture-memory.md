...
- Decision Brief V1 deterministically summarizes an Investigation Thesis using prepared validity and contradiction metadata. Its current view is an unweighted evidence-shape label, not a recommendation, prediction, confidence score, or decision score.
