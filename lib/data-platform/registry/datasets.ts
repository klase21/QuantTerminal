...
const seeds: readonly Seed[] = [
  ...
  ["etf-flow", "ETF Flow", "FACT_FIXED_CADENCE", "governed-external", "SNAPSHOT", ["POSTGRES_FACT", "OBJECT_STORAGE_RAW"], true],
  ["reserve", "Reserve", "FACT_SNAPSHOT", "governed-external", "SNAPSHOT", ["POSTGRES_FACT", "OBJECT_STORAGE_RAW"], true],
  ["macro", "Macro", "FACT_EVENT", "governed-external", "EVENT", ["POSTGRES_FACT", "OBJECT_STORAGE_RAW"], true],
