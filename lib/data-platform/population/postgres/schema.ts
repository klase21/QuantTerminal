export const D3_POPULATION_MIGRATION_ORDER = ["001_population_control_plane.sql", "002_population_roles.sql"] as const
export const D3_POPULATION_TABLES = [
  ...
  "population.candidates", "population.canonical_submissions", "quality.candidate_validation_results",
