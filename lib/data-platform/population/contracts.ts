...
export type PopulationCandidate =
  ...
  | CandidateBase<"MACRO_ECONOMIC_OBSERVATION", { readonly seriesId: string; readonly subject: string; readonly value: string; readonly unit: string; readonly period: string; readonly frequency: string; readonly seasonalAdjustment: string; readonly realtimeStart: string; readonly realtimeEnd: string; readonly releaseIdentity: string; readonly providerTier: string }>
  | CandidateBase<"DAILY_MARKET_CONTEXT_OBSERVATION", { readonly seriesId: string; readonly subject: string; readonly value: string; readonly open: string | null; readonly high: string | null; readonly low: string | null; readonly close: string | null; readonly volume: string | null; readonly timeZone: string; readonly unit: string; readonly period: string; readonly frequency: "DAILY"; readonly licensingState: "LOCAL_MVP_ALLOWED" | "PUBLIC_DEMO_LICENSE_REVIEW_REQUIRED" | "REALTIME_ENTITLEMENT_REQUIRED" | "UNSUPPORTED"; readonly providerTier: string }>
  | CandidateBase<"ETF_FLOW_OBSERVATION", { readonly instrumentId: string; readonly fundId: string; readonly flowValue: string; readonly currency: "USD"; readonly windowStart: string; readonly windowEnd: string; readonly sourceValueState: "ZERO" | "POSITIVE" | "NEGATIVE"; readonly sourceReportedDate: string; readonly providerTier: string }>
