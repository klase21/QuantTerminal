...
async function main() {
  ...
  const payload = { symbol: "BTCUSDT", canonicalInstrumentId: "binance-usdm-perpetual:BTC-USDT", marketType: "USD_M_FUTURES" as const, fundingRate: "0.0001", fundingTime: "2026-07-01T08:00:00.000Z", fundingIntervalHours: 8 }
